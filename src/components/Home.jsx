  ...
  return (
    ...
    <div class="container mx-auto flex items-center h-screen">
        ...
        <div class="w-1/2">
            ...
            <div>
                <a href="/#" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-4">Login</a>
                <a href="/#" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Sign Up</a>
            </div>
        </div>
        <div class="w-1/2">
            <img src="https://wallpapers.com/images/hd/dark-man-standing-idawk015ad468bbi.webp" alt="flower.jpg" class="mx-auto"/>
        </div>
    </div>
  ...
  <div class="relative isolate px-6 pt-14 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      ...
      <div class="text-center">
        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Connecting world</h1>
